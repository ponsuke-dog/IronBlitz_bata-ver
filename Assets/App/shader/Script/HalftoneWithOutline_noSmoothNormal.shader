Shader "Custom/URP/HalftoneWithOutline_noSmoothNormal"
{
    Properties
    {
        [Header(Texture)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert_outline(Attributes IN)
            {
                ...
                float2 normalCS_corrected = float2(normalCS.x / aspect, normalCS.y);

                // クリップ空間で押し出し
                float2 offset = normalize(normalCS_corrected) * _OutlineWidth * 0.01;
